        ...
        else if( assignmentQuestion == 3 )
{
        ...
        ///                                                           ///
        ///                                                           ///
        if ( assignmentQuestion == 1 || assignmentQuestion == 3  )
        {
            centralBodies.push_back( "SSB" );
        }
        else if( assignmentQuestion == 2 )
      ...
      //  boost::shared_ptr< IntegratorSettings< > > integratorSettings;
        ...
        boost::make_shared< TranslationalStatePropagatorSettings< double > >
                ( centralBodies, accelerationModelMap, bodiesToPropagate, lroInitialCartesianState, simulationEndEpoch );
        boost::shared_ptr< IntegratorSettings< > > integratorSettings =
